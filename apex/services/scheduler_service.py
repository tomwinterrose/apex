...
class SchedulerService:
    ...
    def start(self, cron_expression: str | None = None) -> bool:
        ...
        """
        from apex.consumers.scheduler import start_lifecycle_scheduler
    ...
    def stop(self, timeout: float = 30.0) -> bool:
        ...
        Returns:
            True if stopped
        """
        from apex.consumers.scheduler import stop_lifecycle_scheduler
    ...
    def get_status(self) -> SchedulerStatus:
        ...
        """
        from apex.consumers.scheduler import get_scheduler_status
    ...
    def run_once(self) -> SchedulerRunResult:
        ...
        """
        from apex.consumers.scheduler import CronScheduler
