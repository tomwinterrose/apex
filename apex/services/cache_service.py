...
class CacheService:
    ...
    def refresh(
        ...
        """
        from apex.consumers.cache import CacheRefresher
    ...
    def refresh_if_needed(self, max_age_days: int = 7) -> bool:
        ...
        """
        from apex.consumers.cache import refresh_cache_if_needed
    ...
    def expand_leagues(
        ...
        """
        from apex.consumers.cache import expand_leagues
