...
from apex.core import Event, SportsProvider, Team, TeamStats
from apex.database import get_db
from apex.database.provider_cache import (
    dict_to_event,
    dict_to_stats,
    dict_to_team,
    event_to_dict,
...
from apex.database.team_cache import get_team_identity
from apex.providers import ProviderRegistry
from apex.utilities.cache import (
    CACHE_TTL_SCHEDULE,
...
def _ensure_registry_initialized() -> None:
    ...
    from apex.services.league_mappings import init_league_mapping_service
...
def create_default_service() -> "SportsDataService":
    ...
    Providers are registered in apex/providers/__init__.py.
