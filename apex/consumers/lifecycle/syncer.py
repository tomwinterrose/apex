...
class ChannelSyncer(_LifecycleHost):
    ...
    def _sync_channel_settings(
        ...
        try:
            ...
            # 2. Check channel number - Apex DB is source of truth
            ...
            from apex.database.settings import get_dispatcharr_settings as _get_ds
    ...
    def _sync_channel_profiles(
        ...
        """
        from apex.database.channels import update_managed_channel
