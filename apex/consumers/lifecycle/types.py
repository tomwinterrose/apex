...
def generate_event_tvg_id(
    ...
    Returns:
        ...
        - "apex-event-401547679-prelims"
        - "apex-event-401547679-spanish"
        - "apex-event-401547679-prelims-spanish"
        - "apex-event-401547679-feed-23"
        - "apex-event-401547679-spanish-feed-23"
    """
    parts = [f"apex-event-{event_id}"]
    if segment:
