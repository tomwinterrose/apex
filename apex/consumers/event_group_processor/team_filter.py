...
from apex.consumers.channel_lifecycle import create_lifecycle_service
from apex.core import SEASON_POSTSEASON, Event
...
class TeamFiltering:
    ...
    def _get_effective_team_filter(
        ...
        """
        from apex.database.settings import get_team_filter_settings
    ...
    def _cleanup_team_filtered_channels(
        ...
        """
        from apex.database.channels import get_managed_channels_for_group
