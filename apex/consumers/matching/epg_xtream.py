"""Xtream-Codes provider EPG support (epic apexv2-crs).
...
# they're distinguishable in logs and never collide with DP's "_Apex" guard.
...
def _cache_dir() -> Path:
    ...
    if env := os.getenv("APEX_CACHE_DIR"):
        d = Path(env)
