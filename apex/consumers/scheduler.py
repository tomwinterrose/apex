...
from apex.dispatcharr import ChannelManager, get_dispatcharr_client, get_dispatcharr_connection
from apex.services import create_cache_service
...
class CronScheduler:
    ...
    def _start_sub_schedulers(self) -> None:
        """Start independent sub-schedulers for backup and channel reset."""
        from apex.database.settings import get_backup_settings, get_scheduler_settings
    ...
    def restart_sub_task(self, task_name: str) -> None:
        ...
        if task_name == "backup":
            ...
            from apex.database.settings import get_scheduler_settings
    ...
    def _task_channel_reset(self) -> dict:
        ...
        Purges all Apex channels from Dispatcharr.
...
def start_lifecycle_scheduler(
    ...
    from apex.database.settings import get_epg_settings, get_scheduler_settings
