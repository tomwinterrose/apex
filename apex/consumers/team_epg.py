...
from apex.consumers.event_epg import prepend_postponed_label
from apex.core import Event, Programme, TemplateConfig
from apex.services import SportsDataService
from apex.templates.conditions import get_condition_selector
from apex.templates.context_builder import ContextBuilder
from apex.templates.resolver import TemplateResolver
from apex.utilities.event_status import is_event_final
from apex.utilities.sports import get_effective_duration
...
class TeamEPGGenerator:
    ...
    def generate_auto_discover(
        ...
        if sport == "soccer":
            from apex.consumers.cache import get_cache
    ...
    def _generate_fillers(
        ...
        from apex.consumers.filler import FillerGenerator, FillerOptions
    ...
    def _load_filler_config(self, options: TeamEPGOptions):
        ...
        if options.template_id:
            try:
                ...
                from apex.database.templates import get_template, template_to_filler_config
    ...
    def _load_programme_template(self, template_id: int) -> TemplateConfig | None:
        ...
        try:
            from apex.database import get_db
            from apex.database.templates import get_template, template_to_programme_config
