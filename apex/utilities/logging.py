"""Centralized logging configuration for Apex.
...
def setup_logging(
    ...
    error_log = log_path / "apex_errors.log"
    ...
    logger.info("[STARTUP] Apex %s - Dynamic EPG Generator for Sports Channels", VERSION)
    logger.info("[STARTUP] " + "=" * 60)
