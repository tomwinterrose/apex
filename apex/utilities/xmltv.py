...
from apex.core import Programme
from apex.utilities.art_url import apply_art_base_url
from apex.utilities.tz import format_datetime_xmltv, to_user_tz
...
def _add_programme(root: Element, programme: Programme, art_base_url: str = "") -> None:
    ...
    if programme.filler_type:
        prog_elem.append(Comment(f"apex:filler-{programme.filler_type}"))
    ...
    # Note: Apex does not detect actual stream resolution - this is user-configured
