...
from apex.api.startup_state import StartupPhase, get_startup_state
from apex.config import BASE_VERSION, set_display_settings, set_timezone
from apex.database import get_db, init_db
from apex.database.settings import get_display_settings, get_epg_settings, get_scheduler_settings
from apex.database.stats import cleanup_stuck_runs
from apex.dispatcharr import close_dispatcharr, get_factory
from apex.providers import ProviderRegistry
from apex.services import (
...
def _run_startup_tasks():
    ...
    try:
        ...
        logger.info("[STARTUP] Apex ready")
...
async def lifespan(app: FastAPI):
    ...
    setup_logging()
    logger.info("[STARTUP] Starting Apex...")
    ...
    # Shutdown
    logger.info("[SHUTDOWN] Shutting down Apex...")
    ...
    logger.info("[SHUTDOWN] Apex stopped")
