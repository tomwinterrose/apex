...
def _parse_xmltv_for_live_stats(
    ...
    V2 adds comments inside <programme> for filler: apex:filler-pregame, etc.
    ...
    """
    try:
        # Parse with comments enabled to detect apex metadata
...
def clear_all_runs():
    ...
    """
    from apex.database.stats import clear_all_runs
