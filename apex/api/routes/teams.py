...
from apex.database.leagues import get_league_id, get_league_sport
from apex.database.teams import (
...
from apex.services.team_channel_status import build_team_channel_status
from apex.services.team_import import ImportTeam
from apex.services.team_import import bulk_import_teams as do_import
...
def bulk_import_teams(request: BulkImportRequest):
    ...
    deduplication, indexing). See apex/services/team_import.py.
    """
