...
class EPGSettingsModel(BaseModel):
    ...
    epg_output_path: str = "./data/apex.xml"
...
# Dynamic dict - sports are defined in apex/database/settings/types.py DurationSettings
...
class DisplaySettingsModel(BaseModel):
    ...
    xmltv_generator_name: str = "Apex"
    xmltv_generator_url: str = "https://github.com/tomwinterrose/apex"
...
class UpdateCheckSettingsModel(BaseModel):
    ...
    github_repo: str = "apex"  # Repository name (for forks)
