...
from apex.dispatcharr import get_dispatcharr_client
from apex.services import create_scheduler_service
...
def get_lifecycle_settings():
    ...
    from apex.database.settings import get_lifecycle_settings
