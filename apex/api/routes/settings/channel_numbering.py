...
from apex.database.channel_numbers import arm_channel_relayout, get_global_channel_mode
...
def get_channel_numbering_settings():
    ...
    from apex.database.settings import get_channel_numbering_settings
