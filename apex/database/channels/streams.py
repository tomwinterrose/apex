...
from apex.dispatcharr.factory import get_dispatcharr_client
...
def update_stream_window(
    ...
    Used by epic apexv2-183.5 (bead apexv2-095): the window is recomputed
...
def get_ordered_stream_ids(
    ...
    (epic apexv2-183.5): a stream is active when it has no window
