...
class DispatcharrProgram:
    ...
    ids so the matcher (epic apexv2-183) can link a program back to the
    ...
    epg_source: str | None = None  # source name; "_Apex" = our own generated EPG
    ...
    def is_apex(self) -> bool:
        """True if this program came from Apex's own generated EPG source."""
        return self.epg_source == "_Apex"
